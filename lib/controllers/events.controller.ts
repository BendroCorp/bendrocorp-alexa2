...
export const EventsIntentHandler : RequestHandler = {
    ...
    handle(handlerInput : HandlerInput) : Response {
      ...
      if (handlerInput.requestEnvelope.session.user.accessToken) {
        ...
        let auxResponse = "It looks like you have not linked your BendroCorp account with the Alexa voice service yet. I have added a link card to your Alexa app. You will need to link your account before you can access any personalized features."
        return handlerInput.responseBuilder
        .speak(auxResponse)
        .withLinkAccountCard()
        .getResponse();
